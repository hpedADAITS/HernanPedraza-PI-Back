...
const swaggerDefinition = {
    ...
    schemas: {
      ...
      EventSettings: {
        ...
        properties: {
          ...
          maxRequestsPerParticipant: { type: "integer", default: 3, minimum: 0 },
        },
      },
      Event: {
        type: "object",
        properties: {
          ...
          state: { type: "string", enum: ["DRAFT", "LIVE", "ENDED", "CANCELLED"] },
  ...
  tags: [
    ...
    { name: "Participants", description: "Join/leave events, participant management" },
  ...
  paths: {
            ...
            "application/json": {
              schema: {
                ...
                properties: {
                  ...
                  role: { type: "string", enum: ["ATTENDEE", "DJ"], default: "ATTENDEE" },
                },
              },
            },
          },
    ...
    "/events/access/{accessCode}": {
      get: {
        ...
        security: [{ BearerAuth: [] }],
        parameters: [
          { name: "accessCode", in: "path", required: true, schema: { type: "string" } },
        ],
        responses: {
          200: {
              ...
              "application/json": {
                schema: {
                  ...
                  properties: {
                    ...
                    data: {
                      type: "object",
                      properties: { song: { $ref: "#/components/schemas/Song" } },
                    },
                  },
                },
              },
                ...
                schema: {
                  ...
                  properties: {
                    ...
                    data: {
                      type: "object",
                      properties: {
                        queue: { type: "array", items: { $ref: "#/components/schemas/Song" } },
                      },
                    },
                  },
                },
                ...
                schema: {
                  ...
                  properties: {
                    ...
                    data: {
                      type: "object",
                      properties: {
                        pending: { type: "array", items: { $ref: "#/components/schemas/Song" } },
                      },
                    },
                  },
                },
          ...
          content: {
            "application/json": {
              schema: {
                ...
                required: ["durationMs"],
                properties: {
                  durationMs: { type: "integer", description: "Cooldown duration in milliseconds" },
                  reason: { type: "string" },
                },
              },
            },
              ...
              "application/json": {
                schema: {
                  ...
                  properties: {
                    ...
                    data: {
                      type: "object",
                      properties: { vote: { $ref: "#/components/schemas/Vote" } },
                    },
                  },
                },
              },
