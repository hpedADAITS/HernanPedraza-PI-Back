...
router.get("/access/:accessCode", eventsController.getEventByAccessCode.bind(eventsController));
...
router.post("/:eventId/start", eventsController.startEvent.bind(eventsController));
router.post("/:eventId/end", eventsController.endEvent.bind(eventsController));
router.post("/:eventId/cancel", eventsController.cancelEvent.bind(eventsController));

// Participants
router.get("/:eventId/participants", eventsController.getParticipants.bind(eventsController));
